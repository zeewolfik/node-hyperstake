...
Client.prototype = {
    ...
    unlock: function (command, args, fn) {
        ...
        this.opts.passphrasecallback(command, args, function (err, passphrase, timeout, staking) {
